...
public interface AvailabilityRepository extends JpaRepository<Availability, String> {
  @Query(value = "SELECT * FROM m_availability WHERE physiotherapist_id = :physiotherapistId AND date = :date", nativeQuery = true)
  ...
  @Query(value = "SELECT * FROM m_availability WHERE physiotherapist_id = :physiotherapistId AND date = :date " +
